...
public class DownloadImagesBoundService
    ...
    private static class RequestHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            // TODO -x- you fill in here.
            final Uri uri = requestMessage.getImageURL();
            ...
            // Activity.
            final Runnable downloadImageAndReply = new Runnable() {
                /**
                ...
                public void run() {
                    ...
                    // TODO -x- you fill in here.
                    Uri imagePathUri = NetUtils.downloadImage(mService.get().getApplicationContext(), uri, directoryPathname);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -x- you fill in here.
                    sendPath(messenger, imagePathUri, uri, requestCode);
                }
            };
        ...
        public void sendPath(Messenger messenger,
            ...
            ReplyMessage replyMessage =
                    ReplyMessage
                            .makeReplyMessage(pathToImageFile, url, requestCode);
            try {
                Log.d(TAG,
                        "sending "
                                + pathToImageFile
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d(TAG, "onDestroy service called");
